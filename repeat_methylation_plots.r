...
#create plots
pdf(paste(args[1],'_repeat_methylation.pdf',sep=''),h=10,w=12)
plot(x=NULL,y=NULL,xlim=c(-1000,2000),ylim=c(0,100),xlab='',ylab='% methylation',main=paste(args[1],' methylation over repeats',sep=''))
